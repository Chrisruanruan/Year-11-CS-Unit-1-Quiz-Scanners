...
public class Scanners {
    ...
    public static void main(String[] args) {
        ...
        // 10.Declare and initialize a variable of type String called info to a sentence that uses the four variables
        // that you created. The format of this sentence will be as follows:
